...
Este projeto foi desenvolvido como trabalho final da disciplina **Desenvolvimento Front-End para Web**.

---

## 🚀 Funcionalidades

- ✅ SPA (Single Page Application) com JavaScript puro  
- 🎨 Tema claro/escuro + alto contraste  
- 📱 Layout responsivo (mobile-first)  
- 🧾 Formulário de cadastro com máscaras (CPF, telefone, CEP)  
- 🏅 Geração de certificado em PDF (jsPDF)  
- 📂 Navegação sem recarregar a página  
- 💾 Salva tema escolhido no LocalStorage  
...
JavaScript | Interatividade e SPA  
jsPDF | Gerar certificado PDF  
Git + GitHub | Versionamento e publicação  
Termux | Controle via celular (desenvolvimento)  
